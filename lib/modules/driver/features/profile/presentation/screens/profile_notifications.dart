...
class DriverProfileNotifications extends StatefulWidget {
  const DriverProfileNotifications({super.key});

  @override
  State<DriverProfileNotifications> createState() =>
      _DriverProfileNotificationsState();
}

class _DriverProfileNotificationsState extends State<DriverProfileNotifications> {
